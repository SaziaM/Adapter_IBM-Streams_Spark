// t2s4dataU11totalTweets


#ifndef BEJWRMSO2SUKSSQW1NCZJL0NMCSLPTS0PBGBAOGG_1_H_
#define BEJWRMSO2SUKSSQW1NCZJL0NMCSLPTS0PBGBAOGG_1_H_
...
#define SELF BeJwrMSo2SUksSQw1NCzJL0nMCSlPTS0pBgBaogg_1
...
public:
    ...
    typedef SPL::uint64 totalTweets_type;

    enum { num_attributes = 2 } ;
    
    SELF() : Tuple(), data_(), totalTweets_() {}
    SELF(const Self & ot) : Tuple(), data_(ot.data_), totalTweets_(ot.totalTweets_) 
      { constructPayload(ot); }
    SELF(const data_type & _data, const totalTweets_type & _totalTweets) : Tuple(), data_(_data), totalTweets_(_totalTweets) { }
    ...
    totalTweets_type & get_totalTweets() { return totalTweets_; }
    const totalTweets_type & get_totalTweets() const { return totalTweets_; }
    void set_totalTweets(const totalTweets_type & _totalTweets) { totalTweets_ = _totalTweets; }
    ...
    size_t hashCode() const
    {
        ...
        s = 37 * s + std::tr1::hash<totalTweets_type >()(totalTweets_);
        return s;
    }
    ...
    { 
        ...
        std::swap(totalTweets_, ot.totalTweets_);
...
#undef SELF
#endif // BEJWRMSO2SUKSSQW1NCZJL0NMCSLPTS0PBGBAOGG_1_H_ 
