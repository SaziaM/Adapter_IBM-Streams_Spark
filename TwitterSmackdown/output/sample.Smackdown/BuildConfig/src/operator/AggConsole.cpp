...
bool MY_BASE_OPERATOR::globalIniter() {
    instantiators_.insert(std::make_pair("AggConsole",&initer));
    return true;
}
...
{
    ::SPL::Functions::Utility::printStringLn(::SPL::spl_cast<SPL::rstring, SPL::BeJwrMSo2NCnOTUzOTskvzwvPL0opzjTPTSxJzkgtBgCYfQra >::cast(iport$0));
}
