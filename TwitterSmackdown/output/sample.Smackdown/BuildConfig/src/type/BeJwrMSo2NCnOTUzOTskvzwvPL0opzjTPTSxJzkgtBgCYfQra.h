...
#ifndef BEJWRMSO2NCNOTUZOTSKVZWVPL0OPZJTPTSXJZKGTBGCYFQRA_H_
#define BEJWRMSO2NCNOTUZOTSKVZWVPL0OPZJTPTSXJZKGTBGCYFQRA_H_
...
public:
    ...
    typedef SPL::int32 matches_type;

    enum { num_attributes = 2 } ;
    
    SELF() : Tuple(), smackdownWords_(), matches_() {}
    SELF(const Self & ot) : Tuple(), smackdownWords_(ot.smackdownWords_), matches_(ot.matches_) 
      { constructPayload(ot); }
    SELF(const smackdownWords_type & _smackdownWords, const matches_type & _matches) : Tuple(), smackdownWords_(_smackdownWords), matches_(_matches) { }
    ...
    matches_type & get_matches() { return matches_; }
    const matches_type & get_matches() const { return matches_; }
    void set_matches(const matches_type & _matches) { matches_ = _matches; }
    ...
    size_t hashCode() const
    {
        ...
        s = 37 * s + std::tr1::hash<matches_type >()(matches_);
        return s;
    }
...
#undef SELF
#endif // BEJWRMSO2NCNOTUZOTSKVZWVPL0OPZJTPTSXJZKGTBGCYFQRA_H_ 
